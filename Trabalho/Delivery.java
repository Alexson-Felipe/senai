...
public class Delivery {
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (menu >= 1 && menu <= 5) {
				...
				JOptionPane.showMessageDialog(null, "OpÃ§Ã£o nÃ£o encontrada");
			}
	...
	private static void criaVenda() {
		...
		do {
			...
			novaVenda.descricaoVendas = JOptionPane.showInputDialog("DescriÃ§Ã£o da venda");
			...
			if (novaVenda.descricaoVendas.length() >= 5) {
				...
				do {
					...
					if (quantProdutos >= 1 && quantProdutos <= 5) {
						...
						int qualCliente = 0;
						qualCliente = Integer.parseInt(JOptionPane.showInputDialog("Qual o cÃ³digo do cliente"));
				...
				do {
					...
					case 1:
						...
						do {
							...
							venda[i].descricaoVendas = JOptionPane.showInputDialog("DescriÃ§Ã£o da venda");
		...
		if (menu >= 1 && menu <= 3) {
			...
			case 1:
				...
				produtosCadastrar = JOptionPane
						.showInputDialog("Digite as informaÃ§Ãµes do produto \nExe: Teclado pc - 89.90;").split(";");
			...
			case 2:
				...
				for (int i = 0; i < produtosCadastrar.length; i++) {
					...
					if (pesquisa == produto[i].codigoProduto) {
						...
						do {
							menu = Integer.parseInt(JOptionPane
									.showInputDialog("1 - Alterar descriÃ§Ã£o\n2 - Alterar valor\n3 - Sair"));
							switch (menu) {
							case 1:
	...
	private static void editarCliente() {
		...
		for (int i = 0; i < contCliente; i++) {// contCliente
			if (pesquisa == cliente[i].codigo) {
				do {
					menu = 0;
					menu = Integer.parseInt(JOptionPane.showInputDialog("Escolha o campo que vocÃª deseja editar"
							+ "\n1 - Nome\n2 - CPF\n3 - Telefone\n4 - Cancelar"));
	...
	private static void fazRelatorio() {
		...
		menu = 0;
		menu = Integer.parseInt(JOptionPane.showInputDialog(
				"1 - Relatório de Vendas - Ordenado pelo menor código Mostrar todas as vendas com o total de cada uma; Mostrar a soma de todas as vendas \n2 - Relatório de Vendas - Ordenado pela menor venda Mostrar todas as vendas com o total de cada uma; Mostrar a soma de todas as vendas"
						+ "\n3 - Relatório de Produtos - Ordenado pelo menor código Mostrar todos os produtos com seus respectivos dados* \n4 - Relatório de Produtos - Ordenado pelo preço do menor produto "
						+ "Mostrar todos os produtos com seus respectivos dados \n5 - Relatório de Clientes - Ordenado pelo menor código "
		...
		if (menu >= 1 && menu <= 5) {
			...
			case 1:
				/**
				 * Relatório de Vendas - Ordenado pelo menor código Mostrar todas as vendas com
			...
			case 2:
				/**
				 * Relatório de Vendas - Ordenado pela menor venda Mostrar todas as vendas com o
			...
			case 3:
				/**
				 * Relatório de Produtos - Ordenado pelo menor código Mostrar todos os produtos
			...
			case 4:
				/**
				 * Relatório de Produtos - Ordenado pelo preço do menor produto Mostrar todos os
			...
			case 5:
				/**
				 * Relatório de Clientes - Ordenado pelo menor código Mostrar todos os clientes
				 * com seus respectivos dados
				 */
				listarRelatorio(5);
