...
public class Deliv {
	...
	private static void editarCliente() {
		...
		int pesquisa = Integer.parseInt(JOptionPane.showInputDialog("Digite o seu codigo"));
		...
		for (int i = 0; i < cliente.length ; i++) {
			if (pesquisa == cliente[i].codigo) {
				do {
					...
					switch (menu) {
					case 1:
						cliente[i].nome = JOptionPane.showInputDialog("Digite o novo nome");
						break;
					case 2:
						cliente[i].cpf = Integer.parseInt(JOptionPane.showInputDialog("Digite o novo cpf"));
						break;
					case 3:
						cliente[i].telefone = Integer.parseInt(JOptionPane.showInputDialog("Digite o novo numero do telefone"));
						break;
					default:
						break;
					}
