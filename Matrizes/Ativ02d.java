 ...
 * [x][1] para armazenar o salário; Após a leitura desses dados informe o nome e
 * o salário dos funcionários que recebem mais de R$2000,00
 *
 */

public class Ativ02d {
	...
	public static void main(String[] args) {
		...
		/**
		 * Felipe - 1900 Bianca - 3100 Luan - 5000 Carol - 3500 Fatima - 1800
		 */
		...
		for (int i = 0; i < 5; i++) {
			...
			if (Integer.parseInt(funcionario[i][1]) > 2000) {
				System.out.println("O salario do funcionario: " + funcionario[i][0] + " é maior que '2000' "
						+ String.format("%.2f", Double.parseDouble(funcionario[i][1])));
			}
		}
	}
